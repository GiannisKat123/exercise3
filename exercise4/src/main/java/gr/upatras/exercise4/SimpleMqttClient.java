...
// subscriber or both
	...
	public static final String TOPIC = "grupatras/lab/engine/exercise3";
...
// Publish the message
				log.info("Publishing to topic \"" + topic + "\" qos " + pubQoS + "\" id " + id + "\" value " + val);
